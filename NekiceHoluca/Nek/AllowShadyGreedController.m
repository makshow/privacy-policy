...
@interface AllowShadyGreedController ()
...
@implementation AllowShadyGreedController
...
- (void)createProgressView {
    ...
    layer.backgroundColor = (__bridge CGColorRef _Nullable)([UIColor orangeColor]);
...
- (void)maskRoughLadder:(NSString *)address {
